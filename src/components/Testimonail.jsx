...
function Testimonail() {
  ...
  viewport={{once:true}}
  className= ' container mx-auto py-10 w-full overflow-hidden lg:px-32' id='Testimonails'>

        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Customer <span className='underline underline-offset-4 decoration-1 font-light'>Testimonails</span></h1>
